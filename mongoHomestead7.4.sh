...
sudo touch /etc/php/7.4/mods-available/mongodb.ini
sudo echo "; configuration for php mongo module\n; priority=30\nextension=mongodb.so" >> /etc/php/7.4/mods-available/mongodb.ini
sudo ln -s /etc/php/7.4/mods-available/mongodb.ini 30-mongodb.ini
